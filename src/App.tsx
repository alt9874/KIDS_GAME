    ...
    <div className="fixed inset-0 w-full h-full bg-[#f0f7ff] overflow-hidden font-sans touch-none select-none">
      <AnimatePresence mode="wait">
            ...
            <div className="max-w-7xl w-full bg-transparent p-4 sm:p-10 flex flex-col gap-3 sm:gap-6 max-h-screen sm:max-h-[98vh] overflow-hidden">
              <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-4 pb-4 sm:pb-8 shrink-0 border-b border-slate-200/50">
                <div className="flex flex-col items-center sm:items-start space-y-1">
                  ...
                  <p className="text-slate-500 font-bold text-lg sm:text-2xl">올바른 의약품 정보만 클릭하세요!</p>
                </div>
                <div className="text-center sm:text-right">
                  <p className="text-emerald-500 sm:text-emerald-600 font-black text-sm sm:text-xl animate-pulse">고득점에 도전해보세요</p>
                </div>
              </div>
        ...
        {gameState === 'result' && (() => {
          ...
          // 최대: 30점 * 37개 = 1110, 최저: -30점 * 37개 = -1110
          const theoreticalMax = 1110;
          const theoreticalMin = -1110;
                ...
                <div className="flex-1 p-6 sm:p-14 flex flex-col items-center justify-center text-center relative overflow-hidden shrink-0 border-b md:border-b-0 md:border-r border-white/20">
                  <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="z-10 w-full flex flex-col items-center justify-center">
                    <div className="relative w-full flex flex-col items-center">
                      ...
                      <div className="absolute bottom-6 sm:bottom-10 bg-transparent/0.5 backdrop-blur-[2px] text-black px-6 sm:px-10 py-1.5 sm:py-3 rounded-2xl sm:rounded-[2rem] font-black shadow-lg flex items-center gap-2 sm:gap-4 ring-1 ring-white/30">
